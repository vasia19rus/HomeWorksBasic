...
class Road:
    ...
    def tonna(self, kg, sm):
        print("Расчёт массы асфальта на указанные параметры - " + str(self._length * self._width * kg * sm) + " т")


km = input("Введите длину покрытия в километрах ")
while not km.isnumeric():
    km = input("Введите длину покрытия в километрах ")
sh = input("Введите ширину покрытия в метрах ")
while not sh.isnumeric():
    sh = input("Введите ширину покрытия в метрах ")
r = Road(int(km), int(sh))
r.tonna(25, 5)
